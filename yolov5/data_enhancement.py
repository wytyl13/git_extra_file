...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='data/to_train_data/image_original')
    parser.add_argument('--source_xml_path', type=str, default='data/to_train_data/image_voc')
    parser.add_argument('--save_img_path', type=str, default='data/to_train_data/image_original_enhancement')
    parser.add_argument('--save_xml_path', type=str, default='data/to_train_data/image_voc_enhancement')
