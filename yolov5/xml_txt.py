 ...
 * @Author: weiyutao
 * @Date: 2023-08-05 15:35:18
 * @Last Modified by: weiyutao
 * @Last Modified time: 2023-08-05 15:35:18
 * @Description: xml file to txt file. and divided the original data
...
xml_file_path = 'data/to_train_data/image_voc_enhancement/'  # 检查和自己的xml文件夹名称是否一致
images_file_path = 'data/to_train_data/image_original_enhancement/'  # 检查和自己的图像文件夹名称是否一致
# 改成自己的类别名称
classes = ["cotton", "other"]
